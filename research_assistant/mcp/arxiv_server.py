...
# load_dotenv('/home/nikunjagrwl/Documents/Research-assistant/research_assistant/research_agent')
...
# # --- Tool: Search ArXiv ---
# def search_tool(query: str, max_results: int):
...
# # --- Tool: Get Abstract ---
# def read_abstract_tool(arxiv_id: str):
...
# # --- Tool: Download PDF ---
# def download_pdf_tool(arxiv_id: str):
...
# def list_recent_tool(category: str, max_results: int):
...
#                 server_name=server.name, # Use the server name defined above
