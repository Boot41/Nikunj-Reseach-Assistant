...
2. Add questions by generating them from a Markdown file.  
3. Run the quiz interactively, allowing the user to answer questions and receive feedback.  
